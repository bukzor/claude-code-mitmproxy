...
Status:
M llm-design-kb/SKILL.md
 M llm-kb/.claude/todo.kb/2026-06-03-000-validate-path-references.md
 M llm-kb/.claude/todo.md
?? design-next.kb/
?? llm-design-kb/CLAUDE.md
?? llm-design-kb/principles.kb/
?? llm-kb/.claude/todo.kb/2026-07-09-000-body-markdown-path-link-checker.md
?? llm-kb/2026-06-03-000-validate-path-references.prototype/

Recent commits:
19c35ce llm-subtask: use file-relative $ref in ideas schema stub
492758b llm-kb: fix incomplete docs/adr migration from 9e19743
65db6ae llm-kb: capture ad-hoc-directory case study; case-studies date -> custom type
e0d4990 llm-kb: promote pattern-recognition over promotion procedure
9e19743 llm-kb: migrate docs/adr to docs/dev/adr, fix dangling link