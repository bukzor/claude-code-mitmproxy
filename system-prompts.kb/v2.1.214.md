...
Use `$CLAUDE_JOB_DIR/tmp` (`/home/bukzor/.claude/jobs/0e43542d/tmp`) for any temporary files (scripts, query files, intermediate outputs) instead of `/tmp` — parallel bg jobs share `/tmp` and clobber each other's files. This directory already exists and is cleaned up when the job is deleted.
...
Status:
M .claude/todo.kb/2026-07-11-000-settle-task-grain-and-store-count-for-design-next.md
 M .claude/todo.md
 M design-next.kb/020-goals.kb/self-application.md
 M design-next.kb/030-requirements.kb/action-triggers-enforced-deterministically.md
RM design-next.kb/030-requirements.kb/coupling-is-layer-3-only.md -> design-next.kb/030-requirements.kb/coupling-is-adapter-only.md
 M design-next.kb/030-requirements.kb/dated-records-are-primitive.md
 M design-next.kb/040-design.kb/CLAUDE.md
RM design-next.kb/040-design.kb/genre-epistemic.md -> design-next.kb/040-design.kb/class-epistemic.md
RM design-next.kb/040-design.kb/thin-skills.md -> design-next.kb/040-design.kb/class-package.md
RM design-next.kb/040-design.kb/genre-record.md -> design-next.kb/040-design.kb/class-record.md
RM design-next.kb/040-design.kb/genre-task.md -> design-next.kb/040-design.kb/class-task.md
RM design-next.kb/040-design.kb/genre-trigger.md -> design-next.kb/040-design.kb/class-trigger.md
RM design-next.kb/040-design.kb/five-layer-stack.md -> design-next.kb/040-design.kb/core-and-classes.md
 M design-next.kb/040-design.kb/decisions-are-settled-questions.md
RM design-next.kb/040-design.kb/delivery-contract.md -> design-next.kb/040-design.kb/delivery-boundary.md
D  design-next.kb/040-design.kb/hook-wiring.md
 M design-next.kb/040-design.kb/kb-engine.md
 M design-next.kb/040-design.kb/kb-spec.md
D  design-next.kb/040-design.kb/plugin-delivery.md
 M design-next.kb/070-future-work.kb/marketplace-distribution.md
 M design-next.kb/070-future-work.kb/skills-over-mcp.md
 M design-next.kb/CLAUDE.md
 M llm-kb/.claude/todo.md
?? llm-kb/.claude/todo.kb/2026-07-13-000-cross-kb-cooperation-conventions.md

Recent commits:
18548c4 todo: queue d-a-s-q rewrite + why: alignment; T2 brief gains 4th open question
88b03bb design-next.kb: path-reference why:/superseded-by, restore status lifecycle
6716a56 T2/v2.2: brief + review-gated execution pipeline in todo.md
7f52c5c llm-kb: debold the last "Validation" label in pattern-guide.md
bd4ce5a llm-kb: path-reference validation prototype + todo split