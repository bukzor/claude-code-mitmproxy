...
You have been invoked in the following environment: 
 ...
 - Platform: linux
 - Shell: bash
 - OS Version: Linux 6.6.119-09251-gf81e51484dec
...
Recent commits:
7ccaffc f5: the opening paragraph still described the pre-audit expectation
6bfdb0f devlog: the import pass, and the three imports re-derivation changed
c96f4ef phase-1-merge: state what is left after the import pass
233ca9d f5: punch list worked, consent queue opened, r1 prep consumed
3764f7b mission: merge the ratified "version control for belief" statement